  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 px-4 py-6">
      <section className="space-y-4">
        <div className="rounded-xl border border-[color:var(--color-outline)] p-5">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="space-y-2">
              <h1 className="text-2xl font-semibold text-black">Finance Command Center</h1>
              <p className="text-sm text-gray-600">
                Integrate ARR, cash flow, and profitability to steer revenue operations.
              </p>
            </div>
      ...
      {activeTab === "Billing" && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className={cn(TRS_SECTION_TITLE)}>Invoices & Billing</h2>
      ...
      {activeTab === "Subscriptions" && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className={cn(TRS_SECTION_TITLE)}>Recurring Revenue</h2>
              <p className={TRS_SUBTITLE}>
      ...
      {activeTab === "Expenses" && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className={cn(TRS_SECTION_TITLE)}>Expenses & P&L</h2>
              <p className={TRS_SUBTITLE}>
      ...
      {activeTab === "Cash Flow" && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className={cn(TRS_SECTION_TITLE)}>Cash Flow & Forecasting</h2>
              <p className={TRS_SUBTITLE}>
